...
def generate_hierarchy(base_seed: int = 2002):
    ...
    inst_50_3F = inst_50_3F.create_subset(50, "50B_3F", seed=base_seed)
    ...
    return inst_100_3F, inst_75_3F, inst_100_6F, inst_75_6F

os.makedirs("logs", exist_ok=True)
os.makedirs("instance_files", exist_ok=True)
os.makedirs("model_variables_csv", exist_ok=True)

inst_100_3F, inst_75_3F, inst_100_6F, inst_75_6F = generate_hierarchy()

BASE_INSTANCES = [inst_100_6F]
